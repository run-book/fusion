...
import { FusionWorkbenchState, legalParamsL, paramsL, routeL } from "../state/fusion.state";
import { FocusOnSetValueButton, FocusOnToggleButton, Loading, MultipleSelects } from "@fusionconfig/react_components";
...
export function FusionNav<S> ( { state }: LensProps<S, FusionWorkbenchState, any> ) {
  ...
  >
    ...
    <Loading state={paramsState.state2 ()}>{_ => <MultipleSelects state={paramsState}/>}</Loading>
